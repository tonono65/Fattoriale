...
def main():
    ...
    print("\n" * 3)
    print("****************************************************************************************" + "\n" +  
          "***************** PRIMO METODO: MOLTIPLICAZIONI ELEMENTARI IN BASE 10 *****************" + "\n" +
          "******************************************************************   ìnizio log " + time.strftime("%H:%M:%S") +
          "\n")
    log_me( "\n" * 3 + 
            "****************************************************************************************" + "\n" +  
    ...
    for i in range(2, fattoriale + 1,1):
        ...
        fattorialeRisultato = fattorialeRisultato * i
    ...
    fattorialeRisultatoStr = str(fattorialeRisultato)
    ...
    print("\n" * 3)
    print("****************************************************************************************" + "\n" +  
          "******* SECONDO METODO: MOLTIPLICAZIONI DI VETTORI DI INTERI IN BASE PARAMETRICA ******" + "\n" +
          "******************************************************************   ìnizio log " + time.strftime("%H:%M:%S") +
          "\n")
    log_me( "\n" * 3 + 
            "****************************************************************************************" + "\n" +  
